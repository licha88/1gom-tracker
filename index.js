...
// Tăng counter - chỉ gọi từ 1gom.run
...
// Trang admin - truy cập thẳng vào Railway domain
app.get('/admin', function(req, res) {
  ...
  for(var i=0;i<days.length;i++){
    rows += '<tr><td style="padding:10px 0;color:#8b949e;font-size:14px">'+days[i]+'</td>' +
            '<td style="padding:10px 0;color:#4ade80;font-weight:bold;font-size:18px;text-align:right">'+visits[days[i]]+' lượt</td></tr>';
  }
  ...
  res.send('<!DOCTYPE html><html><head><meta charset="UTF-8">' +
    ...
    '<h2 style="color:#f59e0b;margin:0 0 24px">📊 Traffic - 1gom.run</h2>' +
    ...
    '<div style="color:#38bdf8;font-size:40px;font-weight:bold">'+total+'</div></div>' +
    '<div style="background:#161b22;border:1px solid #30363d;border-radius:12px;padding:20px;text-align:center">' +
    '<div style="color:#8b949e;font-size:11px;margin-bottom:8px">HÔM NAY</div>' +
    '<div style="color:#4ade80;font-size:40px;font-weight:bold">'+todayN+'</div></div>' +
    '</div>' +

    '<div style="background:#161b22;border:1px solid #30363d;border-radius:12px;padding:16px;margin-bottom:16px">' +
    '<div style="color:#f59e0b;font-size:13px;margin-bottom:12px">📅 30 ngày gần nhất</div>' +
